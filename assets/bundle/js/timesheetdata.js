...
var newHireDays = 0; //If employee is a new hire, it indicates how many days should disable in that joining week starting from saturday
...
/* returns hours for perticular project on selected day
 obj - JSON object of a project, n - day for which you want hours(0-6) 0-Sat ... 6-Fri*/
function getHours(obj,n){
    var hours = 0;
    switch(n){
        case 0: //SAT
            hours = parseFloat(obj.DAY6);//obj.DAY1
            return isNaN(hours)?0:hours;
            break;
        case 1: //SUN
            hours = parseFloat(obj.DAY7);//obj.DAY2
            return isNaN(hours)?0:hours;
            break;
        case 2: //MON
            hours = parseFloat(obj.DAY1);//obj.DAY3
            return isNaN(hours)?0:hours;
            break;
        case 3: //TUE
            hours = parseFloat(obj.DAY2);//obj.DAY4
            return isNaN(hours)?0:hours;
            break;
        case 4: //WED
            hours = parseFloat(obj.DAY3);//obj.DAY5
            return isNaN(hours)?0:hours;
            break;
        case 5: //THU
            hours = parseFloat(obj.DAY4);//obj.DAY6
            return isNaN(hours)?0:hours;
            break;
        case 6: //FRI
            hours = parseFloat(obj.DAY5);//obj.DAY7
            return isNaN(hours)?0:hours;
            break;
        default:
            return 0;
                ...
                switch(k){
                    case 0:
                        //if(obj.DAY1_CHANGED == 1){/*Cahnged on 18-Dec to send all details even if hours modified. This change made for everyday upto case 6 below*/
                            ...
                            }else if(track_obj.DAY1 != '-' || (obj.DAY1_ATTR_ID != 0&& obj.DAY1_ATTR_ID != undefined && attrChanged)){//Update
                    ...
                    case 1:
                        //if(obj.DAY2_CHANGED == 1){
                            if(obj.DAY2_CHANGED == 1 && (obj.DAY2_DETAIL_ID == 0|| obj.DAY2_DETAIL_ID == undefined)){//Create
                                ...
                                json.data[json.data.length] = updateattrJson;
                            }else if(track_obj.DAY2 != '-' || (obj.DAY2_ATTR_ID != 0&& obj.DAY3_ATTR_ID != undefined && attrChanged)){
                    ...
                    case 2:
                        //if(obj.DAY3_CHANGED == 1){
                            if(obj.DAY3_CHANGED == 1 && (obj.DAY3_DETAIL_ID == 0|| obj.DAY3_DETAIL_ID == undefined)){//Create
                                ...
                                json.data[json.data.length] = updateattrJson;
                            }else if(track_obj.DAY3 != '-' || (obj.DAY3_ATTR_ID != 0&& obj.DAY3_ATTR_ID != undefined && attrChanged)){
                    ...
                    case 3:
                        //if(obj.DAY4_CHANGED == 1){
                            if(obj.DAY4_CHANGED == 1 && (obj.DAY4_DETAIL_ID == 0|| obj.DAY4_DETAIL_ID == undefined)){//Create
                                ...
                                json.data[json.data.length] = updateattrJson;
                            }else if(track_obj.DAY4 != '-' || (obj.DAY4_ATTR_ID != 0&& obj.DAY4_ATTR_ID != undefined && attrChanged)){
                    ...
                    case 4:
                        //if(obj.DAY5_CHANGED == 1){
                            if(obj.DAY5_CHANGED == 1 && (obj.DAY5_DETAIL_ID == 0|| obj.DAY5_DETAIL_ID == undefined)){//Create
                                ...
                                json.data[json.data.length] = updateattrJson;
                            }else if(track_obj.DAY5 != '-' || (obj.DAY5_ATTR_ID != 0&& obj.DAY5_ATTR_ID != undefined && attrChanged)){
                    ...
                    case 5:
                        //if(obj.DAY6_CHANGED == 1){
                            if(obj.DAY6_CHANGED == 1 && (obj.DAY6_DETAIL_ID == 0|| obj.DAY6_DETAIL_ID == undefined)){//Create
                                ...
                                json.data[json.data.length] = updateattrJson;
                            }else if(track_obj.DAY6 != '-' || (obj.DAY6_ATTR_ID != 0&& obj.DAY6_ATTR_ID != undefined && attrChanged)){
                    ...
                    case 6:
                        //if(obj.DAY7_CHANGED == 1){
                            if(obj.DAY7_CHANGED == 1 && (obj.DAY7_DETAIL_ID == 0|| obj.DAY7_DETAIL_ID == undefined)){//Create
                                ...
                                json.data[json.data.length] = updateattrJson;
                            }else if(track_obj.DAY7 != '-' || (obj.DAY7_ATTR_ID != 0&& obj.DAY7_ATTR_ID != undefined && attrChanged)){
